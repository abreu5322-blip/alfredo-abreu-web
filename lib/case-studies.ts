...
export const caseStudies: CaseStudy[] = [
  {
    ...
    approachEn: [
      ...
      'Revenue-first keyword architecture: Rebuilt their keyword strategy around terms with commercial intent, such as "nearshoring companies USA" and "staff augmentation Mexico," rather than just high-volume informational terms.',
    ...
    approachEs: [
      ...
      'Arquitectura de keywords orientada al revenue: Reconstruimos su estrategia de keywords en torno a términos con intención comercial (como "nearshoring companies USA", "staff augmentation Mexico", etc.), no solo términos informativos de alto volumen.',
  ...
  },
  {
    ...
    approachEn: [
      'Technical foundation: Fixed critical on-page SEO issues, including missing meta tags, duplicate content, broken internal links, and slow page load times. Implemented local schema markup (LocalBusiness, NonprofitOrganization).',
    ...
    approachEs: [
      'Base técnica: Corregimos problemas críticos de SEO on-page, como meta tags faltantes, contenido duplicado, links internos rotos y tiempos de carga lentos. Implementamos schema markup local (LocalBusiness, NonprofitOrganization).',
  ...
  },
  {
    ...
    approachEn: [
      'Hyper-local keyword architecture: Rebuilt their keyword strategy around Massachusetts-specific terms, such as "tutoring services Boston", "SAT prep Massachusetts", and "math tutor Newton MA", targeting actual geographic areas where their clients lived.',
    ...
    approachEs: [
      'Arquitectura de keywords hiper-local: Reconstruimos su estrategia de keywords en torno a términos específicos de Massachusetts, como "tutoring services Boston", "SAT prep Massachusetts" y "math tutor Newton MA", apuntando a las áreas geográficas reales donde vivían sus clientes.',
    ...
    resultsEs: 'Al redirigir el tráfico de visitantes nacionales genéricos a prospectos locales calificados, todas las métricas mejoraron dramáticamente. Los nuevos usuarios orgánicos crecieron un 208%, el tráfico orgánico total aumentó un 128%, y los usuarios recurrentes se dispararon un 295%, lo que indica que los visitantes locales estaban interactuando con la marca repetidamente antes de convertir. El tiempo promedio de engagement aumentó un 38%, confirmando que los nuevos visitantes eran mucho más calificados que antes.',
    resultMetrics: [
  ...
  },
  {
    ...
    subtitleEn: 'A California waxing supplies company only ranking for branded terms, attracting retail buyers when they needed wholesale clients.',
    subtitleEs: 'Una empresa de suministros para cera de California que solo rankeaba por términos de marca, atrayendo compradores retail cuando necesitaba clientes wholesale.',
    metrics: [
    ...
    challengeEn: [
      'WXB sold professional waxing supplies to salons, estheticians, and beauty professionals (a B2B wholesale business). But their SEO was entirely branded, meaning they only appeared when someone specifically searched for "WXB" instead of the wholesale waxing supplies terms that their actual buyers used.',
    ...
    approachEn: [
      'Wholesale-intent keyword research: Identified and prioritized keywords with clear B2B/wholesale purchasing intent, such as "wholesale wax supplies", "professional waxing kits bulk", and "hard wax wholesale distributor California", and rebuilt their content strategy around these terms.',
    ...
    approachEs: [
      'Investigación de keywords con intención wholesale: Identificamos y priorizamos keywords con clara intención de compra B2B/wholesale, como "wholesale wax supplies", "professional waxing kits bulk" y "hard wax wholesale distributor California", y reconstruimos su estrategia de contenido en torno a estos términos.',
      ...
      'UX orientada a conversión para wholesale: Rediseñamos páginas clave y CTAs para convertir compradores profesionales: visibilidad de precios por volumen, aplicación de cuenta profesional y mensajería específica B2B.',
    ],
